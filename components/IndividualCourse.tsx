...
export default function IndividualCourse({course}:{course:any}) {
  ...
  return (
    <section onClick={handleNavigate} className="border-[1px] border-slate-200 cursor-pointer md:p-6 p-2 flex md:flex-row flex-col">
