...
export default function HomeCategory ({title, number, image}: IPROPS) {
  return (
    <div className="flex bg-[#082b39] text-white border-[1px] border-slate-500 rounded">
      <Image src={image===1?orange:image===2?purple:image===3?blue:image===4?pink:image===5?sky_blue:image===6?yellow:image===7?green:image===8?red:image===9?shiny:black} className="w-1/3 h-24 rounded" alt="Pic"/>
