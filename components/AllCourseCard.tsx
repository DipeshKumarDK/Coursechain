...
export default function AllCourseCard() {
  return (
    <div className="border-[1px] border-slate-200 p-3 mt-2 mb-2 flex">
      <Image src={pic} alt="/" className="w-2/6 h-44" />
      ...
      <div className="w-1/6 flex flex-col justify-center pr-2">
