...
export default function Navbar() {
  return (
    <>
    <section className="flex border-b-[1px] border-t-[1px] border-slate-200 pl-6 pr-6 pt-1 pb-1 bg-[#09384b] text-white sticky top-0">
      ...
      <section className="flex h-full w-full pt-1 pb-1 pl-6 pr-6">
        <div className="flex w-2/3">
          ...
          <div className="flex border-[1px] border-slate-100 ml-5 rounded-l-full rounded-r-full w-full pr-2">
    ...
    <section className="flex justify-between pt-4 pb-4 pl-32 pr-32 border-b-[1px] border-t-[1px] border-slate-100 shadow-md shadow-white bg-[#09384b] text-white">
      ...
      <h4 className="text-sm">Math & Logic</h4>
