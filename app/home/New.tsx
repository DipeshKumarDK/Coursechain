...
export default function New () {
  return (
    <div className="bg-[#082b39] text-white pt-2 pb-14 2xl:pl-24 2xl:pr-24 lg:pl-14 lg:pr-14 sm:pl-10 sm:pr-10 xs:pl-6 xs:pr-6 pl-3 pr-3">
        <h2 className="md:text-3xl text-2xl font-semibold">Newly Launched Courses</h2>
