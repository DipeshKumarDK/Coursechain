...
export default function Instructor() {
  return (
    <div className="pt-8">
      <h3 className="text-2xl font-semibold">Your Journey As An Instructor</h3>
      <section className="pt-6 grid grid-cols-4 gap-[15px]">
        <div className="border-[1px] border-slate-300 pl-3 pr-3 pt-4 pb-7 rounded">
